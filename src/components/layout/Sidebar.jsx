    ...
    <>
      <div className="flex items-center gap-3 pb-6 border-b border-slate-100 mb-4">
        ...
        <button 
          ...
          className="lg:hidden p-1.5 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors focus:outline-none"
        >
          <X className="w-5 h-5" />
        </button>
      </div>
  ...
  return (
    <>
      ...
      <button 
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2.5 bg-white border border-slate-200 rounded-xl shadow-md text-slate-700 hover:bg-slate-50 transition-colors focus:outline-none"
      >
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.aside
            ...
            exit={{ x: -280 }}
            transition={{ type: "spring", stiffness: 300, damping: 30 }}
            className="lg:hidden fixed left-0 top-0 w-[280px] bg-white border-r border-slate-200 flex flex-col p-5 h-screen z-50 shadow-xl"
          >
            {sidebarContent}
          </motion.aside>
        )}
      ...
      <motion.aside 
        ...
        className="hidden lg:flex w-[260px] bg-white border-r border-slate-200 flex-col p-5 sticky top-0 h-screen shrink-0 z-40"
      >
        {sidebarContent}
      </motion.aside>
    </>
